    ...
    return function a(b, c, d) {
            ...
            var h = a(2),
                ...
                l = function(a) {
                    ...
                    return g(b, a), b.prototype.buildCSSClass = function() {
                        ...
                        return c ? void this.setTimeout(function() {
                            c.focus()
                ...
                w = function() {
                    ...
                    return a.prototype.dispose = function() {
                        ...
                        this.on("touchleave", d), this.on("touchcancel", d), this.on("touchend", function(d) {
                            b = null, c === !0 && (new Date).getTime() - a < 200 && (d.preventDefault(), this.trigger("tap"))
                        })
            ...
            var h = a(2),
                ...
                l = function(a) {
                    ...
                    return g(b, a), b.prototype.buildCSSClass = function() {
                        ...
                        this.removeClass("vjs-paused"), this.addClass("vjs-playing"), this.controlText("Pausar")
                    }, b.prototype.handlePause = function(a) {
                        this.removeClass("vjs-playing"), this.addClass("vjs-paused"), this.controlText("Continuar")
                    }, b
                }(i.default);
            l.prototype.controlText_ = "Continuar", k.default.registerComponent("PlayToggle", l), c.default = l
        }, {
            2: 2,
            5: 5
        }],
            ...
            var i = a(81),
                ...
                o = function(a) {
                    ...
                    return h(b, a), b.prototype.createEl = function() {
                        ...
                        return this
                    }, b.prototype.closeable = function a(b) {
                        if ("boolean" == typeof b) {
                            var a = this.closeable_ = !!b,
                                c = this.getChild("closeButton");
                            if (a && !c) {
                                var d = this.contentEl_;
                                this.contentEl_ = this.el_, c = this.addChild("closeButton", {
                                    controlText: "Close Modal Dialog"
                                }), this.contentEl_ = d, this.on(c, "close", this.close)
                            }!a && c && (this.off(c, "close", this.close), this.removeChild(c), c.dispose())
                        }
            ...
            var Z = ["progress", "abort", "suspend", "emptied", "stalled", "loadedmetadata", "loadeddata", "timeupdate", "ratechange", "volumechange", "texttrackchange"],
                $ = function(a) {
                    ...
                    return h(b, a), b.prototype.dispose = function() {
                        ...
                        return a && a.length || (a = (0, C.createTimeRange)(0, 0)), a
        ...
        59: [function(a, b, c) {
            ...
            for (var k = a(62), l = e(k), m = a(81), n = d(m), o = a(92), p = d(o), q = a(90), r = a(58), s = e(r), t = a(5), u = e(t), v = a(95), w = e(v), x = a(88), y = w.default.navigator, z = function(a) {
                    ...
                    return h(b, a), b.prototype.createEl = function() {
                        var a = this.options_;
                        a.swf || (a.swf = "//vjs.zencdn.net/swf/5.3.0/video-js.swf");
                        var c = a.techId,
                            d = (0, x.assign)({
                ...
                J = function(a) {
                    ...
                    return i(b, a), b.prototype.dispose = function() {
                        ...
                        try {
                            ...
                            (0, v.default)(a, "Video is not ready. (Video.js)")
                        }
            ...
            var i = a(67),
                ...
                C = function(a) {
                    ...
                    return h(b, a), b.prototype.addCue = function(a) {
                        ...
                        for (var b = !1, c = 0, d = this.cues_.length; c < d; c++) this.cues_[c] === a && (this.cues_.splice(c, 1), b = !0);
        ...
        82: [function(a, b, c) {
            ...
            function l(a, b, c) {
                ...
                var d = function d() {
                    j(a, b, d), c.apply(this, arguments)
                };
        ...
        93: [function(b, c, d) {
            ...
            n.autoSetupTimeout(1, g), g.VERSION = "5.19.0", g.options = x.default.prototype.options_, g.getPlayers = function() {
                ...
                k.prototype.applyStyles = function(a, b) {
                    ...
                    parse: function(a) {
                        ...
                        try {
                                ...
                                switch (n ? n = !1 : l = g(), k.state) {
                                    ...
                                    case "CUE":
                                        try {
                                            ...
                                            k.reportOrThrowError(a), k.cue = null, k.state = "BADCUE";
                                            continue
                                        }
                                        k.state = "CUETEXT";
                                        continue;
                            ...
                            k.reportOrThrowError(a), "CUETEXT" === k.state && k.cue && k.oncue && k.oncue(k.cue), k.cue = null, k.state = "INITIAL" === k.state ? "BADWEBVTT" : "BADCUE"
                        }
                        return this
                    },
                    flush: function() {
...
function(a) {
    "use strict";
    "function" == typeof define && define.amd ? define(["jquery", "videojs", "imagesloaded", "jquery-ui"], a) : a(jQuery, videojs)
}(function(a, b) {
    a.BigVideo = function(c) {
        function v() {
            var b = u.container.outerWidth() < a(window).width() ? u.container.outerWidth() : a(window).width(),
                c = u.container.outerHeight() < a(window).height() ? u.container.outerHeight() : a(window).height(),
                d = b / c;
            u.container.is(a("body")) && a("html,body").css("height", a(window).height() > a("body").css("height", "auto").height() ? "100%" : "auto"), d < j ? "video" == t ? (f.width(c * j).height(c), u.shrinkable ? a(g).css("top", -(b / j - c) / 2).css("left", 0).css("height", b / j) : a(g).css("top", 0).css("left", -(c * j - b) / 2).css("height", c), a(g + "_html5_api").css("width", c * j).css("height", c), a(g + "_flash_api").css("width", c * j).css("height", c)) : a("#big-video-image").css({
                width: "auto",
                height: c,
                top: 0,
                left: -(c * j - b) / 2
            }) : "video" == t ? (f.width(b).height(b / j), a(g).css("top", -(b / j - c) / 2).css("left", 0).css("height", b / j), a(g + "_html5_api").css("width", a(g + "_html5_api").parent().width() + "px").css("height", "auto"), a(g + "_flash_api").css("width", b).css("height", b / j)) : a("#big-video-image").css({
                width: b,
                height: "auto",
                top: -(b / j - c) / 2,
                left: 0
        ...
        function w() {
            var b = '<div id="big-video-control-container"><div id="big-video-control"><a href="#" id="big-video-control-play"></a><div id="big-video-control-middle"><div id="big-video-control-bar"><div id="big-video-control-bound-left"></div><div id="big-video-control-progress"></div><div id="big-video-control-track"></div><div id="big-video-control-bound-right"></div></div></div>\t<div id="big-video-control-timer"></div></div></div>';
            u.container.append(b), a("#big-video-control-container").css("display", "none"), a("#big-video-control-timer").css("display", "none"), a("#big-video-control-track").slider({
                animate: !0,
                step: .01,
                slide: function(b, c) {
                    n = !0, a("#big-video-control-progress").css("width", c.value - .16 + "%"), f.currentTime(c.value / 100 * f.duration())
                },
                stop: function(a, b) {
                    n = !1, f.currentTime(b.value / 100 * f.duration())
                }
            }), a("#big-video-control-bar").click(function(b) {
                f.currentTime(b.offsetX / a(this).width() * f.duration())
            }), a("#big-video-control-play").click(function(a) {
                a.preventDefault(), x("toggle")
            }), f.on("timeupdate", function() {
                if (!n && f.currentTime() / f.duration()) {
                    var b = f.currentTime(),
                        c = Math.floor(b / 60),
                        d = Math.floor(b) - 60 * c;
                    d < 10 && (d = "0" + d);
                    var e = f.currentTime() / f.duration() * 100;
                    a("#big-video-control-track").slider("value", e), a("#big-video-control-progress").css("width", e - .16 + "%"), a("#big-video-control-timer").text(c + ":" + d + "/" + k)
                }
            })
        }
        ...
        function x(b) {
            var c = b || "toggle";
            "toggle" == c && (c = o ? "pause" : "play"), "pause" == c ? (f.pause(), a("#big-video-control-play").css("background-position", "-16px"), o = !1) : "play" == c ? (f.play(), a("#big-video-control-play").css("background-position", "0"), o = !0) : "skip" == c && z()
        }

        function y() {
            f.play(), u.container.off("click", y)
        }

        function z() {
            s++, s === r.length && (s = 0), A(r[s])
        }

        function A(b) {
            a(g).css("display", "block"), t = "video", f.src(b), o = !0, q ? (a("#big-video-control-container").css("display", "none"), f.ready(function() {
                f.volume(0)
            }), doLoop = !0) : (a("#big-video-control-container").css("display", "block"), f.ready(function() {
                f.volume(l)
            }), doLoop = !1), a("#big-video-image").css("display", "none"), a(g).css("display", "block")
        }

        function B(b) {
            a("#big-video-image").remove(), f.pause(), a(g).css("display", "none"), a("#big-video-control-container").css("display", "none"), t = "image";
            var c = a('<img id="big-video-image" src=' + b + " />");
            h.append(c), a("#big-video-image").imagesLoaded(function() {
                j = a("#big-video-image").width() / a("#big-video-image").height(), v()
            })
        }
        var f, s, t, d = {
        ...
        return e.init = function() {
            if (!m) {
                u.container.prepend(h);
                var c = u.forceAutoplay ? "autoplay" : "";
                f = a('<video id="' + g.substr(1) + '" class="video-js vjs-default-skin" height="1" width="1" preload="auto" data-setup="{}" ' + c + " webkit-playsinline></video>"), f.css("position", "absolute"), h.append(f);
                var d = ["html5", "flash"],
                    e = navigator.userAgent.toLowerCase(),
                    i = e.indexOf("firefox") != -1;
                u.useFlashForFirefox && i && (d = ["flash", "html5"]), f = b(g.substr(1), {
                    controls: !1,
                    autoplay: !1,
                    preload: "auto",
                    techOrder: d
                }), u.controls && w(), v(), m = !0, o = !1, u.forceAutoplay && a("body").on("click", y), a("#big-video-vid_flash_api").attr("scale", "noborder").attr("width", "100%").attr("height", "100%"), a(window).on("resize.bigvideo", function() {
                    v()
                }), f.on("loadedmetadata", function(b) {
                    j = document.getElementById("big-video-vid_flash_api") ? document.getElementById("big-video-vid_flash_api").vjs_getProperty("videoWidth") / document.getElementById("big-video-vid_flash_api").vjs_getProperty("videoHeight") : a("#big-video-vid_html5_api").prop("videoWidth") / a("#big-video-vid_html5_api").prop("videoHeight"), v();
                    var c = Math.round(f.duration()),
                        d = Math.floor(c / 60),
                        e = c - 60 * d;
                    e < 10 && (e = "0" + e), k = d + ":" + e
                }), f.on("ended", function() {
                    u.doLoop && (f.currentTime(0), f.play()), p && z()
                })
            }
        }, e.show = function(b, c) {
            if (void 0 === c && (c = {}), q = c.ambient === !0, "string" == typeof b) {
                var d = b.lastIndexOf("?") > 0 ? b.substring(b.lastIndexOf(".") + 1, b.lastIndexOf("?")) : b.substring(b.lastIndexOf(".") + 1);
                "jpg" == d || "gif" == d || "png" == d ? B(b) : "mp4" != d && "ogg" != d && "ogv" != d && "webm" != d || (A(b), c.onShown && c.onShown(), p = !1)
            } else if (a.isArray(b)) A(b);
            else {
                if ("object" != typeof b || !b.src || !b.type) throw "BigVideo.show received invalid input for parameter source";
                A([b])
            }
        }, e.showPlaylist = function(b, c) {
            if (!a.isArray(b)) throw "BigVideo.showPlaylist parameter files accepts only arrays";
            void 0 === c && (c = {}), q = c.ambient === !0, (q || c.doLoop) && (u.doLoop = !0), r = b, s = 0, this.show(r[s]), c.onShown && c.onShown(), p = !0
        }, e.getPlayer = function() {
            return f
        }, e.remove = e.dispose = function() {
            m = !1, h.remove(), a(window).off("resize.bigvideo"), f && (f.off("loadedmetadata"), f.off("ended"), f.dispose())
        }, e.triggerPlayer = function(a) {
            x(a)
        }, e
    }
});